// isolation from document (coffescript)
(function e(t,n,r) {
  function s(o,u) {
    if(!n[o]) {
      if(!t[o]) {
  ...
  /**
   *  This file contain Main Game Logic Engine
   *
   *  Prototype Game encapsulate rendering engine and physics
   *      It set global game configurations and orchestrate initialisation
   *      of the world (it responssible of all game Objects).
   *
   *  Prototype Player contain each a basket/bucket that collect Meme Balls
   *      It responssible of scoring, and displays (avatar/score).
   *
   *  Prototype Ball responssible it's own gravity,
   *      And lauch player bucket capture.
   *
   */
  ...
  Game = (function() {
    function Game(initPlayers) {
      ...
      // all objects ochestrated by game
    ...
    /**
     * Loading Assets textures and sprites
     */
